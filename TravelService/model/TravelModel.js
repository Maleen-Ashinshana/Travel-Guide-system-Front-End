export class TravelModel{
    ...
    constructor(start_date,end_date,no_of_adult,no_of_child,need_a_guide_or_no,total_hed_count,package_total,vehicle_id,guide_id,user,hotel_id,area_list,travelPackage) {
